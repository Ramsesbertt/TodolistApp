    ...
    if(formKey.currentState!.validate()){
      ...
      taskService.addTask(taskModel).then((value) {
        if(value.isNotEmpty){
          ...
          showSnackBarError(context, "Hubo un inconveniente, inténtalo nuevamente");
          Navigator.pop(context);
      });
    }
  }
              ...
              children: [
                FilterChip(
                  ...
                  labelStyle: TextStyle(
                    color: categorySelected == "Personal" ? Colors.white : kBrandPrimaryColor,
                  ),
                  label: Text("Personal"),
                ...
                FilterChip(
                  ...
                  checkmarkColor: Colors.white,
                  labelStyle: TextStyle(
                    color: categorySelected == "Trabajo" ? Colors.white : kBrandPrimaryColor,
                  ),
                  label: Text("Trabajo"),
                  onSelected: (bool value) {
                ...
                FilterChip(
                  ...
                  checkmarkColor: Colors.white,
                  labelStyle: TextStyle(
                    color: categorySelected == "Otro" ? Colors.white : kBrandPrimaryColor,
                  ),
                  label: Text("Otro"),
                  onSelected: (bool value) {
